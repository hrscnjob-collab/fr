...
export default function AdminWorkersPage() {
  ...
  const workersQuery = useQuery({
    queryKey: ['admin-workers', activeApiParams],
      ...
      <div className="flex flex-row items-center justify-between flex-wrap gap-4 border-b border-slate-50 pb-6">
        ...
        <div className="flex items-center gap-3">
          <Button
            ...
            className="bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-xl text-xs h-9 px-4 shadow-sm flex items-center gap-1.5"
          >
